...
function findByKw(item, kw) {
    switch (kw) {
        case item.type: return true;
        case item.color: return true;
        case item.gender: return true;
        case item.price: return true;
        case item.size: return true;
        case item.variation: return true;
